...
def main():
    ...
    if('kind' not in s.session_state or 'type' not in s.session_state or 'year' not in s.session_state or 'month' not in s.session_state or 'data' not in s.session_state):
        ...
        df['pK2_WEIGHTED'],df['pK2_UNWEIGHTED']=n.array(map(pK1,df[' SST_AVE_WEIGHTED_YEAR'],df[' SALINITY_AVE_WEIGHTED_YEAR'])),n.array(map(pK1,df[' SST_AVE_UNWTD_YEAR'],df[' SALINITY_AVE_UNWTD_YEAR']))
